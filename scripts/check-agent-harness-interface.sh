...
for generated_file in AGENTS.md docs/agent-harness.md; do
  grep -Fq -- '<!-- Generated by ai-first 1.3.1.' "$generated_file" ||
...
expected = {
    ...
    "source_commit": "c5af8a9bc23bb36def22d19657bbffec806889fd",
}
...
printf 'agent harness interface is valid: ai-first-harness-v1 / mlgrep overlay\n'
