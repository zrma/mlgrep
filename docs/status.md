...
상태: v0.3.0 released; grep-shaped reference workload complete
...
- Signed `v0.3.0` archives, checksums and installer are published for macOS arm64 and Linux x86_64.
